...
const MILESTONES = [
  ...
  },
  {
    ...
    body: 'We partner with operational businesses in marine, offshore safety, retail and financing, mapping real workflows and shipping production systems alongside them. Every build teaches us what should become a reusable pattern.',
  ...
  },
  {
    ...
    body: 'Selka, our online ordering and booking product for Singapore businesses, launches at selka.sg, built on the same foundations as our custom systems.',
    accent: 'from-primary to-[hsl(var(--fluxo-cyan))]',
  },
  {
    year: 'Next',
    Icon: Infinity,
    title: 'More products, one industry at a time',
    body: 'Patterns that keep repeating across our custom builds, such as maintenance, compliance, scheduling and reports, become ready-made products when there is real demand for them.',
